...
public class Electronics extends Utility {
    ...
    By clearQuantity = (By.cssSelector("#product_enteredQuantity_20"));
    ...
    By verifyMessageShoppingCart = By.cssSelector("div.master-wrapper-page:nth-child(6) div.master-wrapper-content div.master-column-wrapper div.center-1 div.page.shopping-cart-page div.page-title > h1:nth-child(1)");
    public String verifyMessageShoppingCart() {
        return getTextFromElement(verifyMessageShoppingCart);
    }
    //Verify the quantity is 2
    By verifytQuantity = By.xpath("//span[contains(text(),'(2)')]");

    public String verifyQuantity() {
        return getTextFromElement(verifytQuantity);
    }
    ...
    By verifyShopingMethod = By.xpath("//span[text()[normalize-space()='2nd Day Air']]");
    ...
    By verifySuccessfully = By.xpath("//button[@class='button-1 order-completed-continue-button']");
